...
This project is indexed by GitNexus as **LSPotato** (3227 symbols, 5901 relationships, 202 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
