...
This project is indexed by GitNexus as **LSPotato** (7906 symbols, 11344 relationships, 201 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
