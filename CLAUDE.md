...
This project is indexed by GitNexus as **LSPotato** (3331 symbols, 6094 relationships, 201 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
