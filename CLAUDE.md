...
This project is indexed by GitNexus as **LSPotato** (3335 symbols, 6107 relationships, 201 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
