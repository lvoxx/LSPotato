...
class ShaderNodeCompiled_Make_Ray(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_008.outputs['Shader'], Mix_Shader.inputs[1])
        nt.links.new(Group_009.outputs['Shader'], Mix_Shader.inputs[2])
        ...
        nt.links.new(Mix_Shader_001.outputs['Shader'], Add_Shader.inputs[0])
        ...
        nt.links.new(Group_001.outputs['Shader'], Mix_Shader_001.inputs[2])
        ...
        nt.links.new(Add_Shader.outputs['Shader'], Mix_Shader_002.inputs[2])
