...
class ShaderNodeCompiled_Global_Configuration_Loader(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Mix_007.outputs[2], Group_Output.inputs['World Color'])
        nt.links.new(Attribute_006.outputs['Factor'], Mix_003.inputs[0])
        nt.links.new(Group.outputs['Stylized'], Mix_003.inputs[6])
        nt.links.new(Math_002.outputs['Value'], Mix_007.inputs[0])
        nt.links.new(Mix_003.outputs[2], Mix_007.inputs[6])
        nt.links.new(Attribute_005.outputs['Color'], Mix_007.inputs[7])
        nt.links.new(Attribute_008.outputs['Factor'], Math.inputs[0])
        nt.links.new(Attribute_008.outputs['Factor'], Math_001.inputs[0])
        nt.links.new(Attribute_008.outputs['Factor'], Math_002.inputs[0])
