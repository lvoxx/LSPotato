...
class ShaderNodeCompiled_HSR__Build_Body_Package(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        Group_009.node_tree = bpy.data.node_groups['HSR: Body Color From Lightmap']
        ...
        Group_013.node_tree = bpy.data.node_groups['HSR: Seperate Body Lightmap']
        ...
        Group_011.node_tree = bpy.data.node_groups['HSR: Body Color From Lightmap']
        ...
        Group_010.node_tree = bpy.data.node_groups['HSR: Body Color From Lightmap']
        ...
        nt.links.new(Mix_001.outputs['Result'], Group_Output.inputs['Base Color'])
        ...
        nt.links.new(Group_013.outputs['Shadow'], Mix.inputs['Factor'])
