...
class ShaderNodeCompiled_AVR__Metal_Ramp(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(RGB.outputs['Color'], Mix.inputs[6])
        nt.links.new(Brightness_Contrast.outputs['Color'], Mix.inputs[7])
        nt.links.new(Mix.outputs[2], Glossy_BSDF.inputs['Color'])
        ...
        nt.links.new(Mix_003.outputs[1], Group.inputs['Normal'])
        nt.links.new(Glossy_BSDF.outputs['BSDF'], Shader_to_RGB.inputs['Shader'])
        nt.links.new(Group_Input_001.outputs['Use Dot'], Mix_001.inputs[0])
        nt.links.new(Shader_to_RGB.outputs['Color'], Mix_001.inputs[6])
        nt.links.new(Mix_002.outputs[2], Mix_001.inputs[7])
        nt.links.new(Group.outputs['Specular'], Mix_002.inputs[6])
        nt.links.new(Mix.outputs[2], Mix_002.inputs[7])
        nt.links.new(Group_Input.outputs['Normal'], Math.inputs[0])
        nt.links.new(Math.outputs['Value'], Mix_003.inputs[0])
        nt.links.new(Normal_Map.outputs['Normal'], Mix_003.inputs[4])
        nt.links.new(Group_Input.outputs['Normal'], Mix_003.inputs[5])
        ...
        nt.links.new(Group_Input_004.outputs['Value Enhance'], Math_001.inputs[1])
