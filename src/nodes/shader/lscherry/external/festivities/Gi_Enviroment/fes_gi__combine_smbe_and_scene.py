...
class ShaderNodeCompiled_FES_GI__Combine_SMBE_and_Scene(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_Input.outputs['SMBE'], Mix_Shader.inputs[1])
        nt.links.new(Group_Input.outputs['Scene'], Mix_Shader.inputs[2])
        nt.links.new(Add_Shader.outputs['Shader'], Group_Output.inputs['Shader'])
        nt.links.new(Mix_Shader.outputs['Shader'], Add_Shader.inputs[0])
