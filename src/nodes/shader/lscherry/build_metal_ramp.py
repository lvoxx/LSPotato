...
class ShaderNodeCompiled_Build_Metal_Ramp(ShaderNode):
    bl_label = 'lscherry.Build Metal Ramp'
    bl_icon = "NONE"
    _PREFIX = "."
    ...
    def createNodetree(self, name):
        ...
        _sock_inp_Mix_1.default_value = 0.5800000429153442
        _sock_inp_Mix_1.min_value = 0.0
        _sock_inp_Mix_1.max_value = 1000.0
        _sock_inp_Mix_2 = nt.interface.new_socket(name='Mix 2', in_out='INPUT', socket_type='NodeSocketFloat')
        _sock_inp_Mix_2.default_value = 0.800000011920929
        _sock_inp_Mix_2.min_value = 0.0
        _sock_inp_Mix_2.max_value = 1000.0
        ...
        _sock_inp_Mix_3.max_value = 1000.0
        ...
        Group_Input.location = (-846.05, -89.17)
        ...
        Group_Output.location = (1061.2, 363.11)
