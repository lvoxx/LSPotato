...
class ShaderNodeCompiled_Strinova__SSS_Hair_Bundle(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Strinova__SSS_Hair_Bundle'
    bl_label = 'lscherry.starters.strinova.Strinova: SSS Hair Bundle'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Strinova: SSS Hair Bundle'
