...
class ShaderNodeCompiled_Strinova__Mask_1_Range_Hair_Bundle(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Strinova__Mask_1_Range_Hair_Bundle'
    bl_label = 'lscherry.starters.strinova.Strinova: Mask_1 Range Hair Bundle'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Strinova: Mask_1 Range Hair Bundle'

    def init(self, context):
        self.getNodetree(self.name + '_node_tree')
        self.inputs['Range 1'].default_value = 0.009999999776482582
        self.inputs['Range 2'].default_value = 0.4000000059604645
        self.inputs['Range 3'].default_value = 1.0
    ...
    def createNodetree(self, name):
        ...
        _sock_inp_Range_3.default_value = 1.0
