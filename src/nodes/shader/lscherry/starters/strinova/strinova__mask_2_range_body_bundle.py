...
class ShaderNodeCompiled_Strinova__Mask_2_Range_Body_Bundle(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Strinova__Mask_2_Range_Body_Bundle'
    bl_label = 'lscherry.starters.strinova.Strinova: Mask_2 Range Body Bundle'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Strinova: Mask_2 Range Body Bundle'

    def init(self, context):
        self.getNodetree(self.name + '_node_tree')
        self.inputs['Range 1'].default_value = 0.10000000149011612
        self.inputs['Range 2'].default_value = 0.4000000059604645
        self.inputs['Range 3'].default_value = 0.699999988079071
    ...
    def createNodetree(self, name):
        ...
        _sock_inp_Range_3.default_value = 0.699999988079071
