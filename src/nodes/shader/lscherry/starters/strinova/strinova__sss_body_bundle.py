...
class ShaderNodeCompiled_Strinova__SSS_Body_Bundle(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Strinova__SSS_Body_Bundle'
    bl_label = 'lscherry.starters.strinova.Strinova: SSS Body Bundle'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Strinova: SSS Body Bundle'
