...
class ShaderNodeCompiled_Strinova__Shadow_Bundle(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Strinova__Shadow_Bundle'
    bl_label = 'lscherry.starters.strinova.Strinova: Shadow Bundle'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Strinova: Shadow Bundle'
