...
class ShaderNodeCompiled_WuWa__Face_Ramp_Builder(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_WuWa__Face_Ramp_Builder'
    bl_label = 'lscherry.starters.wuthering_waves.WuWa: Face Ramp Builder'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'WuWa: Face Ramp Builder'
    ...
    def createNodetree(self, name):
        ...
        Group_Input.location = (517.74, 203.83)
