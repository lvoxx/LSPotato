...
class ShaderNodeCompiled_Add_Highlight(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Add_Highlight'
    bl_label = 'lscherry.post_production.Add Highlight'
    bl_icon = "NONE"
    _PREFIX = "."
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_Input.outputs['Shading'], Mix_001.inputs[0])
        ...
        nt.links.new(Group_Input.outputs['Shading'], Mix_002.inputs[6])
        nt.links.new(Group_Input.outputs['Color'], Mix_002.inputs[7])
        nt.links.new(Mix_002.outputs[2], Mix.inputs[6])
        nt.links.new(Group_Input.outputs['Pattern'], Mix.inputs[7])
