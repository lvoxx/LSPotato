...
class ShaderNodeCompiled_Add_HightLight_From_LightMap(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Mix_001.outputs[2], Group.inputs['Color'])
        nt.links.new(Group_Input_001.outputs['Pattern'], Group.inputs['Pattern'])
        nt.links.new(Group_Input_002.outputs['LightMap'], Mix_001.inputs[0])
        nt.links.new(Group_Input_002.outputs['Color'], Mix_001.inputs[7])
