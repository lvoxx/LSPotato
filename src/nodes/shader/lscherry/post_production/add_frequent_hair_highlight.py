...
class ShaderNodeCompiled_Add_Frequent_Hair_Highlight(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        _cr.elements[0].position = 0.5342675447463989
        ...
        _cr.hue_interpolation = 'CW'
        while len(_cr.elements) > 1:
            _cr.elements.remove(_cr.elements[-1])
        _cr.elements[0].position = 0.3518475890159607
        _cr.elements[0].color = (0.0, 0.0, 0.0, 1.0)
        _e = _cr.elements.new(0.540909469127655)
        _e.color = (0.5418342351913452, 0.5418342351913452, 0.5418342351913452, 1.0)
        _e = _cr.elements.new(0.7984148859977722)
        _e.color = (1.2999999523162842, 1.2999999523162842, 1.2999999523162842, 1.0)
        _e = _cr.elements.new(1.0)
        _e.color = (2.5371599197387695, 2.5371599197387695, 2.5371599197387695, 1.0)
        ...
        nt.links.new(Separate_XYZ_001.outputs['Z'], Math_001.inputs[0])
        nt.links.new(Group_Input_002.outputs['Z-View Instensity'], Math_001.inputs[1])
        nt.links.new(Group_Input.outputs['Frequency'], Combine_XYZ.inputs['X'])
        nt.links.new(Mix.outputs[2], Mix_001.inputs[0])
        nt.links.new(Group_Input_004.outputs['Color'], Mix_001.inputs[7])
        nt.links.new(Mix_001.outputs[2], Mix_002.inputs[6])
        nt.links.new(Group_Input_004.outputs['Combined'], Mix_002.inputs[7])
        nt.links.new(Mix_005.outputs[2], Group_Output.inputs['Combined'])
        nt.links.new(Group_Input_005.outputs['Toon'], Mix.inputs[0])
        nt.links.new(Mix_003.outputs[2], Mix.inputs[7])
        nt.links.new(Math_002.outputs['Value'], Math.inputs[0])
        nt.links.new(Math_001.outputs['Value'], Math.inputs[1])
        nt.links.new(Math.outputs['Value'], Map_Range_001.inputs['Value'])
        nt.links.new(Math_005.outputs['Value'], Map_Range_001.inputs[1])
        nt.links.new(Group_Input_003.outputs['Z-limit- bot'], Map_Range_001.inputs[2])
        nt.links.new(Group_Input_003.outputs['Z-limit - top'], Math_005.inputs[0])
        nt.links.new(Map_Range.outputs['Result'], Math_004.inputs[0])
        nt.links.new(Map_Range_001.outputs['Result'], Math_004.inputs[1])
        nt.links.new(Math.outputs['Value'], Map_Range.inputs['Value'])
        nt.links.new(Group_Input_003.outputs['Z-limit - top'], Map_Range.inputs[1])
        nt.links.new(Math_005.outputs['Value'], Map_Range.inputs[2])
        nt.links.new(Bright_Contrast.outputs['Color'], Math_003.inputs[0])
        nt.links.new(Separate_XYZ.outputs['Y'], Math_002.inputs[0])
        nt.links.new(Math_003.outputs['Value'], Math_002.inputs[1])
        ...
        nt.links.new(Bright_Contrast_001.outputs['Color'], Mix_004.inputs[0])
        nt.links.new(Math_004.outputs['Value'], Mix_004.inputs[2])
        nt.links.new(Vector_Transform_001.outputs['Vector'], Vector_Math.inputs[0])
        nt.links.new(Vector_Transform.outputs['Vector'], Vector_Math_001.inputs[0])
        nt.links.new(Vector_Math.outputs['Vector'], Vector_Math_001.inputs[1])
        nt.links.new(Mix_004.outputs[0], ColorRamp_001.inputs['Factor'])
        nt.links.new(Group_Input_004.outputs['Mix High And Low Frequent'], Mix_003.inputs[0])
        nt.links.new(ColorRamp_001.outputs['Color'], Mix_003.inputs[6])
        nt.links.new(ColorRamp_002.outputs['Color'], Mix_003.inputs[7])
        nt.links.new(Mix_004.outputs[0], ColorRamp_002.inputs['Factor'])
        nt.links.new(Group_Input_006.outputs['Fac'], Mix_005.inputs[0])
        nt.links.new(Group_Input_004.outputs['Combined'], Mix_005.inputs[6])
