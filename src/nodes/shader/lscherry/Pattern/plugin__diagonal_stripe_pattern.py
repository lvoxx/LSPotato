...
class ShaderNodeCompiled_Plugin__Diagonal_Stripe_Pattern(ShaderNode):
    bl_label = 'lscherry.plugin.Pattern.Plugin: Diagonal Stripe Pattern'
    bl_icon = "NONE"
    _PREFIX = "."
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Math_006.outputs['Value'], Mix.inputs['A'])
        nt.links.new(Math_004.outputs['Value'], Mix.inputs['B'])
        nt.links.new(Math.outputs['Value'], Math_004.inputs['Value'])
        nt.links.new(Group.outputs['Factor X'], Math_005.inputs['Value'])
