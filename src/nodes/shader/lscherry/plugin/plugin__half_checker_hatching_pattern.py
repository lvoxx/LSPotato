...
class ShaderNodeCompiled_Plugin__Half_Checker_Hatching_Pattern(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Plugin__Half_Checker_Hatching_Pattern'
    bl_label = 'lscherry.plugin.Plugin: Half Checker Hatching Pattern'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Plugin: Half Checker Hatching Pattern'
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group.outputs['Factor Y'], Math_001.inputs[1])
        ...
        nt.links.new(Math_001.outputs['Value'], Math.inputs[0])
        ...
        nt.links.new(Math_001.outputs['Value'], Mix.inputs[2])
