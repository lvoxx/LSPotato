...
class ShaderNodeCompiled_Plugin__Watercolor_003_Pattern(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Plugin__Watercolor_003_Pattern'
    bl_label = 'lscherry.plugin.Plugin: Watercolor 003 Pattern'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Plugin: Watercolor 003 Pattern'
    ...
    def createNodetree(self, name):
        ...
        Image_Texture_001.image = load_packaged_image('stroke2.jpg')
