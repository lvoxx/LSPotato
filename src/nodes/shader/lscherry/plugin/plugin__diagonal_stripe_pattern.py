...
class ShaderNodeCompiled_Plugin__Diagonal_Stripe_Pattern(ShaderNode):
    ...
    def draw_label(self):
        return 'Plugin: Diagonal Stripe Pattern'

    def init(self, context):
        self.getNodetree(self.name + '_node_tree')
        self.inputs['Size'].default_value = 0.20000000298023224
    ...
    def createNodetree(self, name):
        ...
        _sock_inp_Size.default_value = 0.20000000298023224
        ...
        nt.links.new(Math_006.outputs['Value'], Math.inputs[0])
        ...
        nt.links.new(Math_006.outputs['Value'], Mix.inputs[2])
        nt.links.new(Math_004.outputs['Value'], Mix.inputs[3])
        nt.links.new(Math.outputs['Value'], Math_004.inputs[1])
        nt.links.new(Group.outputs['Factor X'], Math_005.inputs[0])
        nt.links.new(Group.outputs['Factor Y'], Math_005.inputs[1])
        nt.links.new(Group_Input.outputs['Size'], Math_005.inputs[2])
        nt.links.new(Math_005.outputs['Value'], Math_006.inputs[1])
