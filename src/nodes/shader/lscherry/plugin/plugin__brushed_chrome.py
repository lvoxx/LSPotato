...
class ShaderNodeCompiled_Plugin__Brushed_Chrome(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_Input_001.outputs[7], Noise_Texture.inputs['Scale'])
        ...
        nt.links.new(Group_Input.outputs[0], Math.inputs[0])
        nt.links.new(Group_Input.outputs['Multiplier'], Math.inputs[1])
