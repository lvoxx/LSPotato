...
class ShaderNodeCompiled_Plugin__Painted_006_Pattern(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Plugin__Painted_006_Pattern'
    bl_label = 'lscherry.plugin.Plugin: Painted 006 Pattern'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Plugin: Painted 006 Pattern'
    ...
    def createNodetree(self, name):
        ...
        Image_Texture_001.image = load_packaged_image('stroke3.jpg')
