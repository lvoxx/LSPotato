...
class ShaderNodeCompiled_Plugin__Dot_Hatching_Pattern(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Map_Range.outputs['Result'], Math_002.inputs[0])
        nt.links.new(Group_Input.outputs['Dot Size'], Math_002.inputs[1])
        nt.links.new(Group_Input_001.outputs['Enable Light Dot Blend'], Mix.inputs[0])
        nt.links.new(Math_003.outputs['Value'], Mix.inputs[2])
        ...
        nt.links.new(Group_Input.outputs['Dot Size'], Math_003.inputs[1])
        nt.links.new(Simple_Toon_Dot__Group_002.outputs['NdotL'], Math_001.inputs[1])
