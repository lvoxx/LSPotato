...
class ShaderNodeCompiled_Plugin__Anisotropic_Spherical(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_Input.outputs[5], Mapping.inputs['Scale'])
        nt.links.new(Group_Input.outputs['Mix Various'], Mix.inputs[0])
        nt.links.new(Gradient_Texture.outputs['Color'], Mix.inputs[6])
        nt.links.new(Mapping.outputs['Vector'], Mix.inputs[7])
        nt.links.new(Mix.outputs[2], Noise_Texture.inputs['Vector'])
