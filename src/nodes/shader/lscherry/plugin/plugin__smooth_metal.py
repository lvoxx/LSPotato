...
class ShaderNodeCompiled_Plugin__Smooth_Metal(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_Input.outputs[0], Mapping.inputs['Scale'])
        nt.links.new(Mapping.outputs['Vector'], Voronoi_Texture.inputs['Vector'])
        nt.links.new(Group_Input_001.outputs[4], Voronoi_Texture.inputs['Scale'])
        nt.links.new(Group_Input_001.outputs[5], Voronoi_Texture.inputs['Detail'])
        nt.links.new(Group_Input_001.outputs[6], Voronoi_Texture.inputs['Roughness'])
        nt.links.new(Group_Input_001.outputs[7], Voronoi_Texture.inputs['Lacunarity'])
        nt.links.new(Group_Input_001.outputs['Randomness'], Voronoi_Texture.inputs['Randomness'])
        nt.links.new(Map_Range.outputs['Result'], Mix_002.inputs[0])
        nt.links.new(Mapping.outputs['Vector'], Mix_002.inputs[6])
        nt.links.new(Voronoi_Texture.outputs['Color'], Mix_002.inputs[7])
        nt.links.new(Mix_002.outputs[2], Noise_Texture.inputs['Vector'])
        nt.links.new(Group_Input_002.outputs[9], Noise_Texture.inputs['W'])
        nt.links.new(Group_Input_002.outputs[10], Noise_Texture.inputs['Scale'])
        nt.links.new(Group_Input_002.outputs[11], Noise_Texture.inputs['Detail'])
        nt.links.new(Group_Input_002.outputs[12], Noise_Texture.inputs['Roughness'])
        nt.links.new(Group_Input_002.outputs[13], Noise_Texture.inputs['Lacunarity'])
        nt.links.new(Group_Input_002.outputs[14], Noise_Texture.inputs['Distortion'])
        nt.links.new(Map_Range.outputs['Result'], Mix_003.inputs[0])
        nt.links.new(Mapping.outputs['Vector'], Mix_003.inputs[6])
        nt.links.new(Noise_Texture.outputs['Color'], Mix_003.inputs[7])
        nt.links.new(Mix_003.outputs[2], Noise_Texture_001.inputs['Vector'])
        nt.links.new(Group_Input_003.outputs[15], Noise_Texture_001.inputs['W'])
        nt.links.new(Group_Input_003.outputs[16], Noise_Texture_001.inputs['Scale'])
        nt.links.new(Group_Input_003.outputs[17], Noise_Texture_001.inputs['Detail'])
        nt.links.new(Group_Input_003.outputs[18], Noise_Texture_001.inputs['Roughness'])
        nt.links.new(Group_Input_003.outputs[19], Noise_Texture_001.inputs['Lacunarity'])
        nt.links.new(Group_Input_003.outputs[20], Noise_Texture_001.inputs['Distortion'])
