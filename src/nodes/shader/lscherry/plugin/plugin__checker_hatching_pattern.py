...
class ShaderNodeCompiled_Plugin__Checker_Hatching_Pattern(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group.outputs['Factor X'], Math_001.inputs[0])
        nt.links.new(Group_Input.outputs['Size'], Math_001.inputs[1])
        nt.links.new(Group.outputs['Factor Y'], Math_005.inputs[0])
        nt.links.new(Group_Input.outputs['Size'], Math_005.inputs[1])
        nt.links.new(Math_001.outputs['Value'], Math_002.inputs[0])
        nt.links.new(Math_005.outputs['Value'], Math_002.inputs[1])
        ...
        nt.links.new(Mix.outputs[0], Group_Output.inputs['Pattern'])
        nt.links.new(Math_002.outputs['Value'], Math.inputs[0])
        nt.links.new(Toon_Style.outputs['Shading'], Math.inputs[1])
        ...
        nt.links.new(Group_Input_001.outputs['Enable Light Blend'], Mix.inputs[0])
        nt.links.new(Math_002.outputs['Value'], Mix.inputs[2])
        nt.links.new(Math_004.outputs['Value'], Mix.inputs[3])
        nt.links.new(Math.outputs['Value'], Math_004.inputs[1])
        nt.links.new(Simple_Toon_Dot__Group_002.outputs['NdotL'], Math_003.inputs[1])
