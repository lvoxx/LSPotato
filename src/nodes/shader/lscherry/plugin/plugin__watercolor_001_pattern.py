...
class ShaderNodeCompiled_Plugin__Watercolor_001_Pattern(ShaderNode):
    ...
    def draw_label(self):
        return 'Plugin: Watercolor 001 Pattern'
    ...
    def createNodetree(self, name):
        ...
        Image_Texture_001.image = load_packaged_image('paint-beautiful-of-water-color-background-15899853907OD.jpg')
        ...
        nt.links.new(Mix_003.outputs[2], Voronoi_Texture_001.inputs['Vector'])
        nt.links.new(Mapping_001.outputs['Vector'], Image_Texture_001.inputs['Vector'])
        nt.links.new(Image_Texture_001.outputs['Color'], Mix_004.inputs[6])
        nt.links.new(Voronoi_Texture_001.outputs['Color'], Mix_004.inputs[7])
        nt.links.new(Mapping_002.outputs['Vector'], Mix_003.inputs[6])
        nt.links.new(Noise_Texture.outputs['Factor'], Mix_003.inputs[7])
        nt.links.new(Mix_004.outputs[2], RGB_to_BW.inputs['Color'])
        nt.links.new(Group_Input.outputs['Seed'], Simple_Randomize.inputs['Seed'])
        nt.links.new(Mix_005.outputs[2], Group_Output.inputs['Base Color'])
        nt.links.new(Map_Range.outputs['Result'], Group_Output.inputs['Pattern'])
        nt.links.new(Group_Input_001.outputs['Base Color'], Mix_005.inputs[6])
        nt.links.new(Mix_004.outputs[2], Mix_005.inputs[7])
        nt.links.new(RGB_to_BW.outputs['Val'], Map_Range.inputs['Value'])
        nt.links.new(Math.outputs['Value'], Map_Range.inputs[3])
        nt.links.new(Group_Input_002.outputs['Deep Strength'], Math.inputs[1])
