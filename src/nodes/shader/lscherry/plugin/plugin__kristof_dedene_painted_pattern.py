...
class ShaderNodeCompiled_Plugin__Kristof_Dedene_Painted_Pattern(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        _cr.elements[0].position = 0.20000003278255463
        _cr.elements[0].color = (0.0, 0.0, 0.0, 1.0)
        _e = _cr.elements.new(0.27727293968200684)
        _e.color = (0.671386182308197, 0.671386182308197, 0.671386182308197, 1.0)
        _e = _cr.elements.new(0.3227272629737854)
        _e.color = (0.02894682064652443, 0.02894682064652443, 0.02894682064652443, 1.0)
        ...
        _cr.elements[0].position = 0.20000003278255463
        _cr.elements[0].color = (0.0, 0.0, 0.0, 1.0)
        _e = _cr.elements.new(0.34545478224754333)
        _e.color = (0.671386182308197, 0.671386182308197, 0.671386182308197, 1.0)
        _e = _cr.elements.new(0.41363635659217834)
        _e.color = (0.02894682064652443, 0.02894682064652443, 0.02894682064652443, 1.0)
        ...
        nt.links.new(Mix.outputs[0], Voronoi_Texture.inputs['Smoothness'])
        ...
        nt.links.new(Mix_001.outputs[0], Mapping.inputs['Scale'])
        nt.links.new(Mix_008.outputs[2], Group_Output.inputs['Base Color'])
        nt.links.new(Math_007.outputs['Value'], Group_Output.inputs['Pattern'])
        nt.links.new(Mix_002.outputs[2], Map_Range.inputs['Value'])
        ...
        nt.links.new(Map_Range_001.outputs['Result'], Mix.inputs[2])
        nt.links.new(Group_Input.outputs['Edge Wet Paint'], Math.inputs[0])
        ...
        nt.links.new(Group_Input_001.outputs['Hard Lines Distortion'], Mix_001.inputs[0])
        nt.links.new(Noise_Texture_001.outputs['Factor'], Mix_001.inputs[3])
        ...
        nt.links.new(Mix.outputs[0], Voronoi_Texture_001.inputs['Smoothness'])
        nt.links.new(Math_003.outputs['Value'], Voronoi_Texture_001.inputs['Randomness'])
        nt.links.new(Group_Input.outputs['Scale'], Math_001.inputs[0])
        nt.links.new(Group_Input_002.outputs['Details'], Mix_002.inputs[0])
        nt.links.new(Voronoi_Texture.outputs['Color'], Mix_002.inputs[6])
        nt.links.new(Voronoi_Texture_001.outputs['Color'], Mix_002.inputs[7])
        nt.links.new(Group_Input.outputs['Hard Lines Strength'], Math_002.inputs[0])
        nt.links.new(Math_002.outputs['Value'], Math_003.inputs[0])
        nt.links.new(Map_Range.outputs['Result'], Mix_003.inputs[6])
        nt.links.new(Map_Range_002.outputs['Result'], Mix_003.inputs[7])
        nt.links.new(Ambient_Occlusion.outputs['Color'], Map_Range_002.inputs['Value'])
        nt.links.new(Math_004.outputs['Value'], Map_Range_002.inputs[1])
        nt.links.new(Group_Input_003.outputs['AO strength'], Math_004.inputs[1])
        nt.links.new(Math_007.outputs['Value'], Mix_004.inputs[6])
        nt.links.new(Group_Input_004.outputs['Base Color'], Mix_004.inputs[7])
        nt.links.new(Math_005.outputs['Value'], Mix_005.inputs[0])
        nt.links.new(Mix_004.outputs[2], Mix_005.inputs[6])
        nt.links.new(Hue_Saturation_Value.outputs['Color'], Mix_005.inputs[7])
        nt.links.new(Map_Range_003.outputs['Result'], Hue_Saturation_Value.inputs['Hue'])
        nt.links.new(Mix_006.outputs[2], Hue_Saturation_Value.inputs['Color'])
        nt.links.new(Math_006.outputs['Value'], Mix_006.inputs[6])
        nt.links.new(Group_Input_005.outputs['Details Color'], Mix_006.inputs[7])
        nt.links.new(Math_006.outputs['Value'], Map_Range_003.inputs['Value'])
        nt.links.new(Group_Input_006.outputs['Details'], Math_005.inputs[0])
        nt.links.new(Voronoi_Texture_001.outputs['Distance'], Math_006.inputs[0])
        nt.links.new(Mix_003.outputs[2], Math_007.inputs[0])
        ...
        nt.links.new(Math_009.outputs['Value'], Mix_007.inputs[0])
        nt.links.new(Mix_005.outputs[2], Mix_007.inputs[6])
        nt.links.new(Group_Input_007.outputs['Layer 1 Color'], Mix_007.inputs[7])
        ...
        nt.links.new(Math_010.outputs['Value'], Mix_008.inputs[0])
        nt.links.new(Mix_007.outputs[2], Mix_008.inputs[6])
        nt.links.new(Group_Input_008.outputs['Layer 2 Color'], Mix_008.inputs[7])
        nt.links.new(Group_Input.outputs['Seed'], Math_008.inputs[0])
        nt.links.new(Color_Ramp.outputs['Color'], Math_009.inputs[0])
        nt.links.new(Group_Input_007.outputs['Layer 1'], Math_009.inputs[1])
        nt.links.new(Color_Ramp_001.outputs['Color'], Math_010.inputs[0])
        nt.links.new(Group_Input_008.outputs['Layer 2'], Math_010.inputs[1])
