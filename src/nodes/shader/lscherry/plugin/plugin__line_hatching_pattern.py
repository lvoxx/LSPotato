...
class ShaderNodeCompiled_Plugin__Line_Hatching_Pattern(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Separate_XYZ.outputs['X'], Math.inputs['Value'])
        nt.links.new(Math.outputs['Value'], Math_001.inputs['Value'])
        nt.links.new(Math_002.outputs['Value'], Math_001.inputs['Value'])
        nt.links.new(Group_Input_001.outputs['Size'], Math_002.inputs['Value'])
        ...
        nt.links.new(Mix_001.outputs['Result'], Group_Output.inputs['Pattern'])
        nt.links.new(Group_Input.outputs['Scale'], Math_003.inputs['Value'])
        nt.links.new(Mix.outputs['Result'], Math_003.inputs['Value'])
        nt.links.new(Group_Input.outputs['Scale'], Math_004.inputs['Value'])
        nt.links.new(Mix.outputs['Result'], Math_004.inputs['Value'])
        nt.links.new(Group_Input.outputs['Scale'], Math_005.inputs['Value'])
        nt.links.new(Mix.outputs['Result'], Math_005.inputs['Value'])
        nt.links.new(Group_Input.outputs['Flip Side'], Mix.inputs['Factor'])
        nt.links.new(Math_007.outputs['Value'], Math_006.inputs['Value'])
        nt.links.new(Map_Range.outputs['Result'], Math_006.inputs['Value'])
        nt.links.new(Math_001.outputs['Value'], Math_007.inputs['Value'])
        nt.links.new(Math_006.outputs['Value'], Math_008.inputs['Value'])
        ...
        nt.links.new(Math_009.outputs['Value'], Map_Range.inputs['To Min'])
