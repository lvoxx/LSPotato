...
class ShaderNodeCompiled_Plugin__Scratch_Pattern(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Voronoi_Texture_001.outputs['Distance'], Math.inputs[0])
        nt.links.new(Image_Texture_001.outputs['Alpha'], Math.inputs[1])
        ...
        nt.links.new(Toon_Style.outputs['Shading'], Math_001.inputs[0])
        nt.links.new(Map_Range.outputs['Result'], Math_001.inputs[1])
        ...
        nt.links.new(Group_Input_003.outputs['Enable Light Blend'], Mix.inputs[0])
        nt.links.new(Map_Range.outputs['Result'], Mix.inputs[2])
        nt.links.new(Math_002.outputs['Value'], Mix.inputs[3])
