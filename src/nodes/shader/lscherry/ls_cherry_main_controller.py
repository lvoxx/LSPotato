...
class ShaderNodeCompiled_LS_Cherry_Main_Controller(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        Value.outputs[0].default_value = 0.75
        ...
        nt.links.new(Mix_023.outputs[2], Group_Output.inputs['Back Mask'])
        ...
        nt.links.new(Group_027.outputs['Limited Color'], Mix_008.inputs[7])
        nt.links.new(Mix_024.outputs[2], Mix_006.inputs[6])
        nt.links.new(Group_026.outputs['Limited Color'], Mix_006.inputs[7])
        ...
        nt.links.new(Group_019.outputs['Enhanced Shading'], Mix_001.inputs[0])
        nt.links.new(Mix_002.outputs[2], Mix_001.inputs[6])
        nt.links.new(Mix_004.outputs[2], Mix_001.inputs[7])
        nt.links.new(Group_019.outputs['Enhanced Shading'], Mix_004.inputs[6])
        nt.links.new(Group_Input_007.outputs['Base Color'], Mix_004.inputs[7])
        nt.links.new(Group_019.outputs['Enhanced Shading'], Invert_Color.inputs['Color'])
        nt.links.new(Map_Range_007.outputs['Result'], Mix_005.inputs[6])
        nt.links.new(Group_Input_006.outputs['Rim Color'], Mix_005.inputs[7])
        nt.links.new(Invert_Color.outputs['Color'], Mix_002.inputs[0])
        nt.links.new(Group_Input_007.outputs['Base Color'], Mix_002.inputs[6])
        nt.links.new(Group_Input_008.outputs['Shadow Color'], Mix_002.inputs[7])
        nt.links.new(Mix_005.outputs[2], Mix_015.inputs[6])
        nt.links.new(Map_Range_001.outputs['Result'], Mix_015.inputs[7])
        nt.links.new(Mix_018.outputs[2], Mix_012.inputs[6])
        nt.links.new(Map_Range_001.outputs['Result'], Mix_012.inputs[7])
        nt.links.new(Mix_006.outputs[2], Mix_013.inputs[6])
        nt.links.new(Map_Range_001.outputs['Result'], Mix_013.inputs[7])
        nt.links.new(Group_017.outputs['Shading'], Math.inputs[0])
        ...
        nt.links.new(Group_Input_021.outputs['Pattern'], Mix_021.inputs[7])
        nt.links.new(Mix_019.outputs[2], Mix_023.inputs[6])
        nt.links.new(Group_Input_021.outputs['Pattern'], Mix_023.inputs[7])
        nt.links.new(Invert_Color_001.outputs['Color'], Mix_020.inputs[0])
        nt.links.new(Group_Input_020.outputs['Base Color'], Mix_020.inputs[6])
        nt.links.new(Group_Input_020.outputs['Shadow Color'], Mix_020.inputs[7])
        ...
        nt.links.new(Mix_020.outputs[2], Group_003.inputs['Color A'])
        ...
        nt.links.new(Group_003.outputs['Color'], Mix_018.inputs[6])
        ...
        nt.links.new(Mix_021.outputs[2], Group_013.inputs['Shading'])
        ...
        nt.links.new(Mix_021.outputs[2], Group_017.inputs['Shading'])
        ...
        nt.links.new(Group_Input_027.outputs['Enable Custom Ramp'], Mix_007.inputs[0])
        nt.links.new(Group_002.outputs['NdotL'], Mix_007.inputs[6])
        nt.links.new(Group_Input_027.outputs['Custom Ramp'], Mix_007.inputs[7])
        nt.links.new(Vector_Math.outputs['Value'], Mix_019.inputs[0])
        nt.links.new(Group_004.outputs['NdotL'], Mix_019.inputs[7])
        ...
        nt.links.new(Group_017.outputs['Shading'], Mix_024.inputs[6])
        nt.links.new(Mix.outputs[0], Mix_024.inputs[7])
        nt.links.new(Separate_Color.outputs['Blue'], Mix.inputs[2])
        nt.links.new(Group_001.outputs['Toon'], Separate_Color.inputs['Color'])
        nt.links.new(Group_009.outputs['Shading'], Mix_025.inputs[6])
        nt.links.new(Mix.outputs[0], Mix_025.inputs[7])
        ...
        nt.links.new(Separate_Color_001.outputs['Green'], Math_002.inputs[0])
        nt.links.new(Separate_Color_002.outputs['Blue'], Map_Range_001.inputs['Value'])
        nt.links.new(Value.outputs['Value'], Map_Range_001.inputs[3])
        nt.links.new(Separate_Color_001.outputs['Blue'], Math_004.inputs[0])
        nt.links.new(Group_019.outputs['Enhanced Shading'], Math_004.inputs[1])
        nt.links.new(Math_004.outputs['Value'], Mix_026.inputs[6])
        nt.links.new(Group_019.outputs['Enhanced Shading'], Mix_026.inputs[7])
        nt.links.new(Group_Input_017.outputs['Specular Tint'], Math_005.inputs[0])
        nt.links.new(Mix_026.outputs[2], Math_005.inputs[1])
        ...
        nt.links.new(Fresnel_003.outputs['Factor'], Mix_028.inputs[6])
        nt.links.new(Map_Range_006.outputs['Result'], Mix_028.inputs[7])
        nt.links.new(Group_028.outputs['NdotL'], Map_Range_006.inputs['Value'])
        nt.links.new(Math_006.outputs['Value'], Map_Range_006.inputs[1])
        nt.links.new(Mix_028.outputs[2], Map_Range_007.inputs['Value'])
        nt.links.new(Math_007.outputs['Value'], Map_Range_007.inputs[1])
        nt.links.new(Group_Input_002.outputs['Rim Strength'], Map_Range_007.inputs[4])
        ...
        nt.links.new(Group_023__Mix_007.outputs[2], Separate_Color_002.inputs['Color'])
        nt.links.new(Group_023__Attribute_006.outputs['Factor'], Group_023__Mix_003.inputs[0])
        nt.links.new(Group_023__Group.outputs['Stylized'], Group_023__Mix_003.inputs[6])
        nt.links.new(Group_023__Math_002.outputs['Value'], Group_023__Mix_007.inputs[0])
        nt.links.new(Group_023__Mix_003.outputs[2], Group_023__Mix_007.inputs[6])
        nt.links.new(Group_023__Attribute_005.outputs['Color'], Group_023__Mix_007.inputs[7])
        nt.links.new(Group_023__Attribute_008.outputs['Factor'], Group_023__Math.inputs[0])
        nt.links.new(Group_023__Attribute_008.outputs['Factor'], Group_023__Math_001.inputs[0])
        nt.links.new(Group_023__Attribute_008.outputs['Factor'], Group_023__Math_002.inputs[0])
        nt.links.new(Group_023__Math.outputs['Value'], Group_023__Math_003.inputs[1])
        nt.links.new(Group_018__Mix_005.outputs[2], Mix_010.inputs[6])
        nt.links.new(Group_018__Map_Range_001.outputs['Result'], Group_018__Mix_004.inputs[0])
        nt.links.new(Mix_011.outputs[2], Group_018__Mix_004.inputs[6])
        nt.links.new(Group_Input_017.outputs['Specular Color'], Group_018__Mix_004.inputs[7])
        nt.links.new(Math_005.outputs['Value'], Group_018__Mix_005.inputs[0])
        nt.links.new(Mix_011.outputs[2], Group_018__Mix_005.inputs[6])
        nt.links.new(Group_018__Mix_004.outputs[2], Group_018__Mix_005.inputs[7])
        ...
        nt.links.new(Group_018__Math.outputs['Value'], Group_018__Map_Range_001.inputs[1])
        nt.links.new(Group_Input_017.outputs['Roughness'], Group_018__Math.inputs[1])
