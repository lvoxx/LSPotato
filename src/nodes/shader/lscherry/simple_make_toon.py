...
class ShaderNodeCompiled_Simple_Make_Toon(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Mix_026.outputs[2], Group_Output.inputs['Combined'])
        nt.links.new(Group_Input_001.outputs['Alpha'], Group_Output.inputs['Alpha'])
        nt.links.new(Mix_002.outputs[2], Group_Output.inputs['Toon Mask'])
        ...
        nt.links.new(Group_010.outputs['Toon'], Mix.inputs[6])
        nt.links.new(Group_012.outputs['NdotL'], Mix.inputs[7])
        ...
        nt.links.new(Group_Input.outputs['Enable Dot'], Mix_001.inputs[0])
        nt.links.new(Group_011.outputs['Rim'], Mix_001.inputs[6])
        nt.links.new(Brightness_Contrast.outputs['Color'], Mix_001.inputs[7])
        nt.links.new(Mix.outputs[2], Mix_002.inputs[6])
        nt.links.new(Group_Input.outputs['Pattern'], Mix_002.inputs[7])
        nt.links.new(Mix_001.outputs[2], Mix_003.inputs[6])
        nt.links.new(Group_Input.outputs['Pattern'], Mix_003.inputs[7])
        nt.links.new(Map_Range.outputs['Result'], Group_014.inputs['Mask'])
        nt.links.new(Mix_003.outputs[2], Group_014.inputs['Shading'])
        ...
        nt.links.new(Group_Input_002.outputs['Rim Size'], Map_Range.inputs[1])
        ...
        nt.links.new(Mix_002.outputs[2], Group.inputs['Shading'])
        ...
        nt.links.new(Group_002.outputs['Enhanced Shading'], Mix_004.inputs[6])
        ...
        nt.links.new(Invert_Color.outputs['Color'], Mix_005.inputs[0])
        nt.links.new(Group_Input_007.outputs['Base Color'], Mix_005.inputs[6])
        nt.links.new(Group_Input_008.outputs['Shadow Color'], Mix_005.inputs[7])
        nt.links.new(Group_002.outputs['Enhanced Shading'], Mix_006.inputs[0])
        nt.links.new(Mix_005.outputs[2], Mix_006.inputs[6])
        nt.links.new(Mix_004.outputs[2], Mix_006.inputs[7])
        nt.links.new(Group_014.outputs['Fixed Shading'], Mix_007.inputs[6])
        nt.links.new(Group_Input_009.outputs['Rim Color'], Mix_007.inputs[7])
        nt.links.new(Mix_006.outputs[2], Mix_012.inputs[6])
        nt.links.new(Group_Input_018.outputs['World Color'], Mix_012.inputs[7])
        nt.links.new(Mix_007.outputs[2], Mix_025.inputs[6])
        nt.links.new(Group_Input_018.outputs['World Color'], Mix_025.inputs[7])
        nt.links.new(Mix_012.outputs[2], Mix_026.inputs[6])
        nt.links.new(Mix_025.outputs[2], Mix_026.inputs[7])
        nt.links.new(Mix_026.outputs[2], Group_001.inputs['Combined'])
