...
class ShaderNodeCompiled_Add_Invert_Tint_V_Body(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Add_Invert_Tint_V_Body'
    bl_label = 'lscherry.post_production.Add Invert Tint V-Body'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Add Invert Tint V-Body'
    ...
    def createNodetree(self, name):
        ...
        Group_Input_004.location = (369.05, -299.64)

        Mix_006 = nt.nodes.new('ShaderNodeMix')
        Mix_006.location = (1762.96, 659.15)
