...
class ShaderNodeCompiled_Add_Specular(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Add_Specular'
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_Input_001.outputs['Use Dot'], Mix_002.inputs[0])
        nt.links.new(Group_003.outputs['Specular'], Mix_002.inputs[2])
        nt.links.new(Map_Range_001.outputs['Result'], Mix_002.inputs[3])
        ...
        nt.links.new(Math.outputs['Value'], Map_Range_001.inputs[1])
        nt.links.new(Group_Input_003.outputs['Roughness'], Math.inputs[1])
