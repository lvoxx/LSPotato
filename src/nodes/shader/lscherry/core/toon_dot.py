...
class ShaderNodeCompiled_Toon_Dot(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Geometry.outputs['Incoming'], Vector_Math_004.inputs[0])
        ...
        nt.links.new(Use_Default_Normal.outputs['Normal'], Vector_Math_001.inputs[0])
        nt.links.new(Vector_Rotate.outputs['Vector'], Vector_Math.inputs[0])
        nt.links.new(Vector_Math_004.outputs['Vector'], Vector_Math_003.inputs[0])
        ...
        nt.links.new(Group_Input.outputs['Mix Light and View'], Mix.inputs[0])
        nt.links.new(Vector_Math_003.outputs['Value'], Mix.inputs[2])
        nt.links.new(Vector_Math_002.outputs['Value'], Mix.inputs[3])
        nt.links.new(Mix_001.outputs[0], Combine_XYZ.inputs['Z'])
        ...
        nt.links.new(Mix.outputs[0], Group_Output.inputs['Mix L and V'])
        ...
        nt.links.new(Vector_Math_001.outputs['Vector'], Vector_Math_005.inputs[0])
        nt.links.new(Vector_Math.outputs['Vector'], Vector_Math_005.inputs[1])
        nt.links.new(Vector_Math_004.outputs['Vector'], Vector_Math_006.inputs[0])
        nt.links.new(Vector_Math_005.outputs['Vector'], Vector_Math_006.inputs[1])
        nt.links.new(Vector_Math_006.outputs['Vector'], Vector_Math_007.inputs[0])
        nt.links.new(Vector_Math_007.outputs['Value'], Invert_Color.inputs['Color'])
        nt.links.new(Vector_Math.outputs['Vector'], Vector_Math_008.inputs[0])
        nt.links.new(Combine_XYZ_001.outputs['Vector'], Vector_Math_008.inputs[1])
        nt.links.new(Vector_Math.outputs['Vector'], Vector_Math_009.inputs[0])
        nt.links.new(Combine_XYZ_002.outputs['Vector'], Vector_Math_009.inputs[1])
        nt.links.new(Vector_Math_008.outputs['Value'], Math.inputs[0])
        nt.links.new(Vector_Math_009.outputs['Value'], Math_001.inputs[0])
        nt.links.new(Group_Input_001.outputs['Invert MLight'], Mix_001.inputs[0])
