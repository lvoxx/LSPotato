...
class ShaderNodeCompiled_Specular_Dot(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Specular_Dot'
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Vector_Math_006.outputs['Vector'], Vector_Math_005.inputs[0])
        ...
        nt.links.new(Vector_Math_010.outputs['Vector'], Vector_Math_006.inputs[0])
        nt.links.new(Vector_Rotate.outputs['Vector'], Vector_Math_010.inputs[0])
        nt.links.new(Group_Input.outputs['Normal'], Vector_Math_010.inputs[1])
        nt.links.new(Vector_Math_007.outputs['Vector'], Mix.inputs[0])
        nt.links.new(Vector_Math_012.outputs['Value'], Mix.inputs[2])
        nt.links.new(Vector_Math_005.outputs['Value'], Mix.inputs[3])
        nt.links.new(Group_Input.outputs['Normal'], Mix.inputs[4])
        nt.links.new(Vector_Math_004.outputs['Vector'], Mix.inputs[5])
        nt.links.new(Vector_Rotate_001.outputs['Vector'], Vector_Math_012.inputs[0])
        nt.links.new(Group_Input_002.outputs['Normal'], Vector_Math_012.inputs[1])
        nt.links.new(Vector_Math_012.outputs['Value'], Vector_Math_007.inputs[0])
