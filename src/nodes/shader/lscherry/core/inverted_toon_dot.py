...
class ShaderNodeCompiled_Inverted_Toon_Dot(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Mix.outputs[0], Group_Output.inputs['Mix InvL and V'])
        ...
        nt.links.new(Vector_Math.outputs['Vector'], Vector_Math_005.inputs[0])
        nt.links.new(Combine_XYZ_001.outputs['Vector'], Vector_Math_005.inputs[1])
        nt.links.new(Vector_Math.outputs['Vector'], Vector_Math_006.inputs[0])
        nt.links.new(Combine_XYZ_002.outputs['Vector'], Vector_Math_006.inputs[1])
        nt.links.new(Vector_Math_005.outputs['Value'], Math.inputs[0])
        nt.links.new(Vector_Math_006.outputs['Value'], Math_001.inputs[0])
