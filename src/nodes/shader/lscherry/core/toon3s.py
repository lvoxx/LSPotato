...
class ShaderNodeCompiled_Toon3S(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Subsurface_Scattering_002.outputs['BSSRDF'], Mix_Shader_001.inputs[2])
        nt.links.new(Map_Range.outputs['Result'], Mix_Shader_003.inputs['Factor'])
        nt.links.new(Mix_Shader_002.outputs['Shader'], Mix_Shader_003.inputs[1])
        nt.links.new(Glossy_BSDF_001.outputs['BSDF'], Mix_Shader_003.inputs[2])
        ...
        nt.links.new(Subsurface_Scattering.outputs['BSSRDF'], Mix_Shader.inputs[1])
        nt.links.new(Subsurface_Scattering_001.outputs['BSSRDF'], Mix_Shader.inputs[2])
        ...
        nt.links.new(Glossy_BSDF.outputs['BSDF'], Mix_Shader_002.inputs[2])
