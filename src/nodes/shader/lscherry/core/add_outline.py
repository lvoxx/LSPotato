...
class ShaderNodeCompiled_Add_Outline(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Transparent_BSDF_001.outputs['BSDF'], Mix_Shader_001.inputs[1])
        ...
        nt.links.new(Transparent_BSDF_002.outputs['BSDF'], Mix_Shader_002.inputs[1])
        nt.links.new(Mix_Shader_001.outputs['Shader'], Mix_Shader_002.inputs[2])
