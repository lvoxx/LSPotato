...
class ShaderNodeCompiled_GloTAni__Stylized_Glass(ShaderNode):
    bl_label = 'lscherry.GloTAni: Stylized Glass'
    bl_icon = "NONE"
    _PREFIX = "."
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Map_Range_003.outputs['Result'], Math_002.inputs['Value'])
        nt.links.new(Separate_XYZ_004.outputs['Z'], Math_002.inputs['Value'])
        nt.links.new(Group_Input_005.outputs['Factor'], Math_008.inputs['Value'])
        nt.links.new(Math_002.outputs['Value'], Math_008.inputs['Value'])
        nt.links.new(Math_003.outputs['Value'], Combine_XYZ_001.inputs['Z'])
        nt.links.new(Group_Input_003.outputs['Rotation'], Math_003.inputs['Value'])
        ...
        nt.links.new(Math_001.outputs['Value'], Mix_003.inputs['Factor'])
        nt.links.new(Bright_Contrast.outputs['Color'], Mix_003.inputs['A'])
        ...
        nt.links.new(Group_Input_002.outputs['Opacity'], Mix.inputs['Factor'])
        nt.links.new(Mix_003.outputs['Result'], Mix.inputs['A'])
        nt.links.new(Bright_Contrast_001.outputs['Color'], Mix.inputs['B'])
        nt.links.new(Mix.outputs['Result'], Clamp.inputs['Value'])
        nt.links.new(Clamp.outputs['Result'], Mix_Shader_002.inputs['Factor'])
        nt.links.new(Emission.outputs['Emission'], Mix_Shader_002.inputs['Shader'])
        ...
        nt.links.new(Group_Input_002.outputs['Opacity'], Math_001.inputs['Value'])
