...
class ShaderNodeCompiled_Back_Style(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_003.outputs['Extracted'], Mix_003.inputs[3])
        nt.links.new(Mix_003.outputs[0], Mix_005.inputs[0])
        nt.links.new(Mix_001.outputs[0], Mix_005.inputs[7])
        ...
        nt.links.new(Mix_003.outputs[0], Mix_004.inputs[0])
        nt.links.new(Mix_001.outputs[0], Mix_004.inputs[6])
        nt.links.new(Mix_006.outputs[0], Group_Output.inputs['Shading'])
        nt.links.new(Mix_002.outputs[1], Group_Output.inputs['Back Style'])
        nt.links.new(Group_Input_001.outputs['Back Style'], Math.inputs[0])
        ...
        nt.links.new(Group_Input_004.outputs['Back Style'], Mix_002.inputs[5])
        nt.links.new(Group_Input_005.outputs['Disable Back Style'], Mix_006.inputs[0])
