...
class ShaderNodeCompiled_SSS_Style(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Mix_001.outputs[0], Invert_Color.inputs['Color'])
        nt.links.new(Invert_Color.outputs['Color'], Math_001.inputs[0])
        nt.links.new(Mix_001.outputs[0], Mix.inputs[0])
        nt.links.new(Mix_002.outputs[0], Mix.inputs[7])
        nt.links.new(Math_001.outputs['Value'], Mix_002.inputs[0])
        nt.links.new(Invert_Color.outputs['Color'], Mix_002.inputs[3])
        nt.links.new(Math.outputs['Value'], Mix_003.inputs[0])
        nt.links.new(Group_Input_003.outputs['SSS Intensity'], Mix_003.inputs[2])
        nt.links.new(Separate_XYZ.outputs['Y'], Mix_003.inputs[3])
        nt.links.new(Mix.outputs[2], Math_002.inputs[0])
        nt.links.new(Mix_003.outputs[0], Math_002.inputs[1])
        nt.links.new(Mix_006.outputs[0], Group_Output.inputs['Shading'])
        nt.links.new(Mix_005.outputs[1], Group_Output.inputs['SSS Style'])
        nt.links.new(Math.outputs['Value'], Mix_001.inputs[0])
        nt.links.new(Group_001.outputs['Shading'], Mix_001.inputs[2])
        nt.links.new(Group_002.outputs['Shading'], Mix_001.inputs[3])
        ...
        nt.links.new(Mix_004.outputs[0], Group_002.inputs['Size'])
        ...
        nt.links.new(Group_Input_001.outputs['SSS Style'], Math.inputs[0])
        nt.links.new(Group_Input_001.outputs['Toon Style (If only using Toon Style)'], Math_003.inputs[0])
        ...
        nt.links.new(Mix_004.outputs[0], Group_001.inputs['Size'])
        nt.links.new(Group_Input.outputs['Smooth'], Group_001.inputs['Smooth'])
        nt.links.new(Group_017.outputs['Extracted'], Math_004.inputs[0])
        nt.links.new(Math_003.outputs['Value'], Mix_004.inputs[0])
        nt.links.new(Math_004.outputs['Value'], Mix_004.inputs[3])
        nt.links.new(Math.outputs['Value'], Mix_005.inputs[0])
        nt.links.new(Combine_XYZ.outputs['Vector'], Mix_005.inputs[4])
        nt.links.new(Group_Input_004.outputs['SSS Style'], Mix_005.inputs[5])
        nt.links.new(Group_Input_005.outputs['Disable SSS Style'], Mix_006.inputs[0])
        nt.links.new(Math_002.outputs['Value'], Mix_006.inputs[2])
        nt.links.new(Group_Input_005.outputs['Shading'], Mix_006.inputs[3])
