...
class ShaderNodeCompiled_Toon_Style(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        Group_005.node_tree = ensure_node_group('.lscherry.utils.separator.Number Extract')
        ...
        Group_016.node_tree = ensure_node_group('.lscherry.utils.separator.Number Compress')
        ...
        nt.links.new(Group.outputs['Shading'], Mix_001.inputs[2])
        nt.links.new(Group_015.outputs['Shading'], Mix_001.inputs[3])
        nt.links.new(Mix_003.outputs[0], Mix.inputs[0])
        nt.links.new(Mix_001.outputs[0], Mix.inputs[2])
        nt.links.new(Group_Input_003.outputs['Fresnel (Required)'], Mix.inputs[3])
        nt.links.new(Math.outputs['Value'], Mix_003.inputs[0])
        nt.links.new(Group_Input_003.outputs['Mix With Fresnel'], Mix_003.inputs[2])
        nt.links.new(Group_004.outputs['Extracted'], Mix_003.inputs[3])
        ...
        nt.links.new(Group_Input_001.outputs['Toon Style'], Math.inputs[0])
        ...
        nt.links.new(Mix_004.outputs[0], Group_Output.inputs['Shading'])
        nt.links.new(Mix_002.outputs[1], Group_Output.inputs['Toon Style'])
        ...
        nt.links.new(Combine_XYZ.outputs['Vector'], Mix_002.inputs[4])
        nt.links.new(Group_Input_004.outputs['Toon Style'], Mix_002.inputs[5])
        nt.links.new(Group_Input_005.outputs['Disable Toon Style'], Mix_004.inputs[0])
        nt.links.new(Mix.outputs[0], Mix_004.inputs[2])
        nt.links.new(Group_Input.outputs['Shading'], Mix_004.inputs[3])
