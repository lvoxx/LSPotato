...
class ShaderNodeCompiled_Color_Selector(ShaderNode):
    ...
    bl_label = 'lscherry.utils.separator.Color Selector'
    bl_icon = "NONE"
    _PREFIX = "."
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Math_001.outputs['Value'], Mix_001.inputs[0])
        nt.links.new(Group_Input.outputs['Color 2'], Mix_001.inputs[6])
        nt.links.new(Mix_002.outputs[2], Mix_001.inputs[7])
        nt.links.new(Math_002.outputs['Value'], Mix_002.inputs[0])
        nt.links.new(Group_Input.outputs['Color 3'], Mix_002.inputs[6])
        nt.links.new(Mix_003.outputs[2], Mix_002.inputs[7])
        nt.links.new(Math_004.outputs['Value'], Mix_004.inputs[0])
        nt.links.new(Group_Input.outputs['Color 5'], Mix_004.inputs[6])
        nt.links.new(Mix_005.outputs[2], Mix_004.inputs[7])
        nt.links.new(Math_006.outputs['Value'], Mix_006.inputs[0])
        nt.links.new(Group_Input.outputs['Color 7'], Mix_006.inputs[6])
        nt.links.new(Mix_007.outputs[2], Mix_006.inputs[7])
        nt.links.new(Math_003.outputs['Value'], Mix_003.inputs[0])
        nt.links.new(Group_Input.outputs['Color 4'], Mix_003.inputs[6])
        nt.links.new(Mix_004.outputs[2], Mix_003.inputs[7])
        nt.links.new(Math_005.outputs['Value'], Mix_005.inputs[0])
        nt.links.new(Group_Input.outputs['Color 6'], Mix_005.inputs[6])
        nt.links.new(Mix_006.outputs[2], Mix_005.inputs[7])
        nt.links.new(Group_Input.outputs['Case Number'], Math_005.inputs[0])
        nt.links.new(Group_Input.outputs['Case Number'], Math_006.inputs[0])
        nt.links.new(Group_Input.outputs['Case Number'], Math_004.inputs[0])
        nt.links.new(Group_Input.outputs['Case Number'], Math_003.inputs[0])
        nt.links.new(Group_Input.outputs['Case Number'], Math_002.inputs[0])
        nt.links.new(Group_Input.outputs['Case Number'], Math_001.inputs[0])
        nt.links.new(Group_Input.outputs['Case Number'], Math.inputs[0])
        nt.links.new(Math.outputs['Value'], Mix.inputs[0])
        nt.links.new(Group_Input.outputs['Color 1'], Mix.inputs[6])
        nt.links.new(Mix_001.outputs[2], Mix.inputs[7])
        nt.links.new(Mix.outputs[2], Group_Output.inputs['Selected Color'])
        nt.links.new(Group_Input.outputs['Case Number'], Math_007.inputs[0])
        nt.links.new(Math_007.outputs['Value'], Mix_007.inputs[0])
        nt.links.new(Group_Input.outputs['Color 8'], Mix_007.inputs[6])
        nt.links.new(Mix_008.outputs[2], Mix_007.inputs[7])
        nt.links.new(Group_Input.outputs['Case Number'], Math_008.inputs[0])
        nt.links.new(Math_008.outputs['Value'], Mix_008.inputs[0])
        nt.links.new(Group_Input.outputs['Color 9'], Mix_008.inputs[6])
        nt.links.new(Mix_009.outputs[2], Mix_008.inputs[7])
        nt.links.new(Group_Input.outputs['Case Number'], Math_009.inputs[0])
        nt.links.new(Math_009.outputs['Value'], Mix_009.inputs[0])
        nt.links.new(Group_Input.outputs['Color 10'], Mix_009.inputs[6])
