...
class ShaderNodeCompiled_Set_Color_From_LightMap(ShaderNode):
    ...
    bl_label = 'lscherry.utils.separator.Set Color From LightMap'
    bl_icon = "NONE"
    _PREFIX = "."
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Group_004.outputs['Boolean'], Mix_003.inputs[0])
        nt.links.new(Mix_004.outputs[2], Mix_003.inputs[6])
        nt.links.new(Group_Input.outputs['Map 2'], Mix_003.inputs[7])
        nt.links.new(Group.outputs['Boolean'], Mix_001.inputs[0])
        nt.links.new(Mix_002.outputs[2], Mix_001.inputs[6])
        nt.links.new(Group_Input.outputs['Map 4'], Mix_001.inputs[7])
        nt.links.new(Group_003.outputs['Boolean'], Mix.inputs[0])
        nt.links.new(Mix_001.outputs[2], Mix.inputs[6])
        nt.links.new(Group_Input.outputs['Map 5'], Mix.inputs[7])
        nt.links.new(Group_002.outputs['Boolean'], Mix_004.inputs[0])
        nt.links.new(Group_Input_001.outputs['Map 0'], Mix_004.inputs[6])
        nt.links.new(Group_Input.outputs['Map 1'], Mix_004.inputs[7])
        nt.links.new(Mix.outputs[2], Group_Output.inputs['Color Map'])
        nt.links.new(Group_001.outputs['Boolean'], Mix_002.inputs[0])
        nt.links.new(Mix_003.outputs[2], Mix_002.inputs[6])
        nt.links.new(Group_Input.outputs['Map 3'], Mix_002.inputs[7])
