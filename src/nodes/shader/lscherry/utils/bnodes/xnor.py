...
class ShaderNodeCompiled_XNOR(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        Group.node_tree = ensure_node_group('.lscherry.utils.bnodes.NOR')

        Group_001 = nt.nodes.new('ShaderNodeGroup')
        Group_001.location = (160.0, 20.0)
        Group_001.node_tree = ensure_node_group('.lscherry.utils.bnodes.OR')
        ...
        Group_020.node_tree = ensure_node_group('.lscherry.utils.bnodes.AND')
