...
class ShaderNodeCompiled_Blend_Light(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Blend_Light'
    bl_label = 'lscherry.utils.bnodes.Blend Light'
    bl_icon = "NONE"
    _PREFIX = "."
    ...
    def createNodetree(self, name):
        ...
        _sock_inp_Mix_Add_And_Blend = nt.interface.new_socket(name='Mix Add And Blend', in_out='INPUT', socket_type='NodeSocketFloat')
        _sock_inp_Mix_Add_And_Blend.default_value = 0.0
        _sock_inp_Mix_Add_And_Blend.min_value = 0.0
        _sock_inp_Mix_Add_And_Blend.max_value = 1.0
        _sock_inp_Mix_Add_And_Blend.subtype = 'FACTOR'
        ...
        Group_Input.location = (-892.27, 115.32)
        ...
        Math_003.location = (-184.55, -17.24)
        Math_003.operation = 'ADD'
        Math_003.use_clamp = False
        Math_003.inputs[2].default_value = 0.5

        Math = nt.nodes.new('ShaderNodeMath')
        Math.location = (-184.55, 150.1)
        Math.operation = 'ADD'
        Math.use_clamp = False
        Math.inputs[2].default_value = 0.5

        Math_005 = nt.nodes.new('ShaderNodeMath')
        Math_005.location = (51.68, -188.04)
        ...
        Math_007.location = (289.22, -17.24)
        ...
        Math_006.location = (289.22, 150.1)
        ...
        Math_008.location = (289.22, -188.04)
        ...
        nt.links.new(Group_Input.outputs['Mix Add And Blend'], Mix_002.inputs[0])
        nt.links.new(Mix_001.outputs[2], Mix_002.inputs[6])
        nt.links.new(Combine_Color.outputs['Color'], Mix_002.inputs[7])
        ...
        nt.links.new(Math_002.outputs['Value'], Math_007.inputs[1])
        nt.links.new(Math_001.outputs['Value'], Math_006.inputs[1])
        nt.links.new(Math_005.outputs['Value'], Math_008.inputs[1])
