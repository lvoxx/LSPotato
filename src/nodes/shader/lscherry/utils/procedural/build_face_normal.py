...
class ShaderNodeCompiled_Build_Face_Normal(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Mix_001.outputs[0], Combine_XYZ.inputs['X'])
        nt.links.new(Mix.outputs[0], Combine_XYZ.inputs['Y'])
        nt.links.new(Group_Input.outputs['Face To Y'], Mix.inputs[0])
        nt.links.new(Mix_002.outputs[0], Mix.inputs[2])
        nt.links.new(Mix_003.outputs[0], Mix.inputs[3])
        nt.links.new(Group_Input.outputs['Face To X'], Mix_001.inputs[0])
