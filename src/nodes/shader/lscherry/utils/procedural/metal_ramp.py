...
class ShaderNodeCompiled_Metal_Ramp(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Metal_Ramp'
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Mix_002.outputs[2], Group_Output.inputs['Custom Ramp'])
        ...
        nt.links.new(Invert_001.outputs['Color'], Mix_001.inputs[0])
        nt.links.new(Group_Input.outputs['Lv 1'], Mix_001.inputs[6])
        nt.links.new(Group_Input.outputs['Lv 2'], Mix_001.inputs[7])
        nt.links.new(Invert_002.outputs['Color'], Mix_002.inputs[0])
        nt.links.new(Mix.outputs[2], Mix_002.inputs[6])
        nt.links.new(Group_Input.outputs['Lv 4'], Mix_002.inputs[7])
        nt.links.new(Invert.outputs['Color'], Mix.inputs[0])
        nt.links.new(Mix_001.outputs[2], Mix.inputs[6])
        nt.links.new(Group_Input.outputs['Lv 3'], Mix.inputs[7])
