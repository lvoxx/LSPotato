...
class ShaderNodeCompiled_Nose_Ramp_Builder(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        nt.links.new(Vector_Math_002.outputs['Vector'], Vector_Math_004.inputs[1])
        ...
        nt.links.new(Group_Input.outputs['Min Dot Value'], Map_Range.inputs[1])
        nt.links.new(Group_Input.outputs['Max  Dot Value'], Map_Range.inputs[2])
        nt.links.new(Vector_Math.outputs['Vector'], Vector_Math_003.inputs[0])
        nt.links.new(Vector_Math_001.outputs['Vector'], Vector_Math_003.inputs[1])
