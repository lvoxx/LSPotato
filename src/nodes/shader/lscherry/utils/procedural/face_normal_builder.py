...
class ShaderNodeCompiled_Face_Normal_Builder(ShaderNode):
    bl_idname = 'ShaderNodeCompiled_Face_Normal_Builder'
    bl_label = 'lscherry.utils.procedural.Face Normal Builder'
    bl_icon = "NONE"
    _PREFIX = "."

    def draw_label(self):
        return 'Face Normal Builder'
    ...
    def createNodetree(self, name):
        ...
        _sock_out_Face_OS_Vector = nt.interface.new_socket(name='Face OS-Vector', in_out='OUTPUT', socket_type='NodeSocketVector')
        _sock_out_Face_OS_Vector.default_value = (0.0, 0.0, 0.0)
        _sock_out_Face_OS_Vector.min_value = -3.4028234663852886e+38
        _sock_out_Face_OS_Vector.max_value = 3.4028234663852886e+38
        _sock_out_Face_OS_Vector.hide_value = True
        _sock_out_Face_OS_Vector.dimensions = 3
        ...
        Geometry.location = (-1073.53, 100.35)
        ...
        nt.links.new(Mapping.outputs['Vector'], Group_Output.inputs['Face OS-Vector'])
        ...
        nt.links.new(Group_003__Attribute_002.outputs['Vector'], Group_001.inputs['Light Dir'])
