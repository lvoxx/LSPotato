...
class ShaderNodeCompiled_Face_Normal_Builder(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        Group_003.location = (-1074.27, 205.58)
        Group_003.width = 160.0
        _cls_Group_003 = getattr(bpy.types, 'ShaderNodeCompiled_Named_Properties', None)
        if _cls_Group_003:
            Group_003.node_tree = _cls_Group_003.create_node_group()
        else:
            Group_003.node_tree = bpy.data.node_groups.get('.lscherry.Named Properties')
