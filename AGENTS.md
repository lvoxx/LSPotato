...
This project is indexed by GitNexus as **LSPotato** (3314 symbols, 6046 relationships, 202 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
